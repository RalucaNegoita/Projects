...
public class PhotographerNPCTest {
	...
	@Test
	public void checkPhotographerNPCexists() throws Exception {
	...
	public void testDialogue() {
		...
		Engine en = Kirla.getEngine();
		
		Player player = PlayerTestHelper.createPlayer("player");
		
	    en.step(player, "Hi");
	    assertTrue(Kirla.isTalking());
	    assertEquals(
	    		"#Pictures! Good #Pictures! Memory #Pictures! Buy #Pictures!",
				getReply(Kirla));
	    
	    //en.step(player, "Task");
	    //assertTrue(Kirla.isTalking());
	    //assertEquals(ConversationStates.ATTENDING, en.getCurrentState());
	    //assertEquals( "I create #pictures from your memories.", getReply(Kirla));
	    
	    
	    en.step(player, "Picture");
	    assertEquals(
	    		"Ohmmmmm, I see blury mist, Ohmmmmm. The picture is getting clearer, Ohmmmmm. Just a few more seconds...",
				getReply(Kirla));
	    
	    
	    en.step(player,"Bye");
	    assertEquals(
	    		"Take care.", getReply(Kirla));
